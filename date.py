...
class Date:
    ...
    def is_after(self, other: 'Date') -> bool:
        """ returns True if self Date is after other Date, otherwise False
        >>> date_1 = Date(12, 19, 2021)
        >>> date_2 = Date(12, 18, 2021)
        >>> date_3 = Date(11, 19, 2021)
        >>> date_4 = Date(12, 19, 2020)
        >>> date_5 = Date(12, 20, 2021)
        
        >>> date_1.is_after(date_1)
        False
        >>> date_1.is_after(date_2)
        True
        >>> date_1.is_after(date_3)
        True
        >>> date_1.is_after(date_4)
        True
        >>> date_1.is_after(date_5)
        False
        """
